---
title: Configuration
description: Configure your Hatk project with config.yaml.
---

## Overview

Hatk is configured through `config.yaml` at the project root. Most options can be overridden with environment variables.
...
Directory for static files. Set to `false` to disable static file serving.
